      ...
      >
        ...
        <Form.Item name="position" label="Position" rules={[{ required: true, message: 'Please select position!' }]}>
          <Select>
            ...
            {/* <Select.Option key="left" value="left" disabled>
              Left
            </Select.Option>
            <Select.Option key="right" value="right" disabled>
              Right
            </Select.Option> */}
          </Select>
        </Form.Item>
        ...
        <Form.Item label="Banner" help="Ratio dimension 4:1 (eg: 1600px:400px)">
          {haveBanner ? <ThumbnailBanner banner={banner} style={{ width: '100%' }} /> : (
            <ImgCrop aspect={4 / 1} shape="rect" quality={1} modalTitle="Edit banner image" modalWidth={768}>
              <Upload
                accept="image/*"
