...
import style from './resend-email-verifi.module.less';
...
class Forgot extends PureComponent<IProps, IState> {
  ...
  handleReset = async (data: IForgot) => {
    ...
    try {
      await authService.resendEmailVerification(data.email);
      message.success('An email has been sent to you, please check your inbox');
        ...
        <div className={style['login-page']} style={{ backgroundImage: `url(${ui?.loginPlaceholderImage || '/bg-login.jpeg'})` }}>
          <div className={style['login-box']}>
            ...
            <div className="login-form">
              <h2 className="title">RESEND EMAIL VERIFICATION</h2>
