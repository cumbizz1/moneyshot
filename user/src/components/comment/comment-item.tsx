...
import style from './comment-content.module.less';
        ...
        <div className={style['cmt-item']} key={item._id}>
          ...
          <div className="cmt-content">
            <div className="cmt-user">
              <span>
                <span style={{ textTransform: 'capitalize' }}>{item?.creator?.name || item?.creator?.username || 'N/A'}</span>
            ...
            {canReply && totalReply > 0 && (
              <div className={!isOpenComment ? 'view-cmt' : 'view-cmt active'}>
